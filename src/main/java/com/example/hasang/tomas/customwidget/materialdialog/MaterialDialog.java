...
public class MaterialDialog extends android.app.Dialog {
    ...
    public MaterialDialog() {
        this(AppContext.getInstance().getActivity(), com.rey.material.R.style.Material_App_Dialog_Light);
    }

    public MaterialDialog(Context context) {
        this(context, com.rey.material.R.style.Material_App_Dialog_Light);
    }


    public MaterialDialog(Context context, int style) {
        super(context, style);
        ...
        layout.windowAnimations = com.rey.material.R.style.DialogNoAnimation;
    ...
    private void init(Context context, int style) {
        ...
        titleTextAppearance(com.rey.material.R.style.TextAppearance_AppCompat_Title);
        actionTextAppearance(com.rey.material.R.style.TextAppearance_AppCompat_Button);
    ...
    public MaterialDialog applyStyle(int resId) {
        Context context = getContext();
        TypedArray a = context.obtainStyledAttributes(resId, com.rey.material.R.styleable.Dialog);
        ...
        for (int i = 0, count = a.getIndexCount(); i < count; i++) {
            ...
            if (attr == com.rey.material.R.styleable.Dialog_android_layout_width) {
                layout_width = a.getLayoutDimension(attr, ViewGroup.LayoutParams.WRAP_CONTENT);
                layoutParamsDefined = true;
            } else if (attr == com.rey.material.R.styleable.Dialog_android_layout_height) {
                layout_height = a.getLayoutDimension(attr, ViewGroup.LayoutParams.WRAP_CONTENT);
                layoutParamsDefined = true;
            } else if (attr == com.rey.material.R.styleable.Dialog_di_maxWidth)
                maxWidth(a.getDimensionPixelOffset(attr, 0));
            else if (attr == com.rey.material.R.styleable.Dialog_di_maxHeight)
                maxHeight(a.getDimensionPixelOffset(attr, 0));
            else if (attr == com.rey.material.R.styleable.Dialog_di_dimAmount)
                dimAmount(a.getFloat(attr, 0));
            else if (attr == com.rey.material.R.styleable.Dialog_di_backgroundColor)
                backgroundColor(a.getColor(attr, 0));
            else if (attr == com.rey.material.R.styleable.Dialog_di_maxElevation)
                maxElevation(a.getDimensionPixelOffset(attr, 0));
            else if (attr == com.rey.material.R.styleable.Dialog_di_elevation)
                elevation(a.getDimensionPixelOffset(attr, 0));
            else if (attr == com.rey.material.R.styleable.Dialog_di_cornerRadius)
                cornerRadius(a.getDimensionPixelOffset(attr, 0));
            else if (attr == com.rey.material.R.styleable.Dialog_di_layoutDirection)
                layoutDirection(a.getInteger(attr, 0));
            else if (attr == com.rey.material.R.styleable.Dialog_di_titleTextAppearance)
                titleTextAppearance = a.getResourceId(attr, 0);
            else if (attr == com.rey.material.R.styleable.Dialog_di_titleTextColor) {
                titleTextColor = a.getColor(attr, 0);
                titleTextColorDefined = true;
            } else if (attr == com.rey.material.R.styleable.Dialog_di_actionBackground)
                actionBackground = a.getResourceId(attr, 0);
            else if (attr == com.rey.material.R.styleable.Dialog_di_actionRipple)
                actionRipple = a.getResourceId(attr, 0);
            else if (attr == com.rey.material.R.styleable.Dialog_di_actionTextAppearance)
                actionTextAppearance = a.getResourceId(attr, 0);
            else if (attr == com.rey.material.R.styleable.Dialog_di_actionTextColor)
                actionTextColors = a.getColorStateList(attr);
            else if (attr == com.rey.material.R.styleable.Dialog_di_positiveActionBackground)
                positiveActionBackground = a.getResourceId(attr, 0);
            else if (attr == com.rey.material.R.styleable.Dialog_di_positiveActionRipple)
                positiveActionRipple = a.getResourceId(attr, 0);
            else if (attr == com.rey.material.R.styleable.Dialog_di_positiveActionTextAppearance)
                positiveActionTextAppearance = a.getResourceId(attr, 0);
            else if (attr == com.rey.material.R.styleable.Dialog_di_positiveActionTextColor)
                positiveActionTextColors = a.getColorStateList(attr);
            else if (attr == com.rey.material.R.styleable.Dialog_di_negativeActionBackground)
                negativeActionBackground = a.getResourceId(attr, 0);
            else if (attr == com.rey.material.R.styleable.Dialog_di_negativeActionRipple)
                negativeActionRipple = a.getResourceId(attr, 0);
            else if (attr == com.rey.material.R.styleable.Dialog_di_negativeActionTextAppearance)
                negativeActionTextAppearance = a.getResourceId(attr, 0);
            else if (attr == com.rey.material.R.styleable.Dialog_di_negativeActionTextColor)
                negativeActionTextColors = a.getColorStateList(attr);
            else if (attr == com.rey.material.R.styleable.Dialog_di_neutralActionBackground)
                neutralActionBackground = a.getResourceId(attr, 0);
            else if (attr == com.rey.material.R.styleable.Dialog_di_neutralActionRipple)
                neutralActionRipple = a.getResourceId(attr, 0);
            else if (attr == com.rey.material.R.styleable.Dialog_di_neutralActionTextAppearance)
                neutralActionTextAppearance = a.getResourceId(attr, 0);
            else if (attr == com.rey.material.R.styleable.Dialog_di_neutralActionTextColor)
                neutralActionTextColors = a.getColorStateList(attr);
            else if (attr == com.rey.material.R.styleable.Dialog_di_inAnimation)
                inAnimation(a.getResourceId(attr, 0));
            else if (attr == com.rey.material.R.styleable.Dialog_di_outAnimation)
                outAnimation(a.getResourceId(attr, 0));
            else if (attr == com.rey.material.R.styleable.Dialog_di_dividerColor)
                dividerColor(a.getColor(attr, 0));
            else if (attr == com.rey.material.R.styleable.Dialog_di_dividerHeight)
                dividerHeight(a.getDimensionPixelOffset(attr, 0));
            else if (attr == com.rey.material.R.styleable.Dialog_di_cancelable)
                cancelable(a.getBoolean(attr, true));
            else if (attr == com.rey.material.R.styleable.Dialog_di_canceledOnTouchOutside)
     ...
     */
    public MaterialDialog clearContent() {
        title(0);
        positiveAction(0);
     ...
     * @return The Dialog for chaining methods.
     */
    public MaterialDialog layoutParams(int width, int height) {
        mLayoutWidth = width;
     ...
     * @return The Dialog for chaining methods.
     */
    public MaterialDialog maxWidth(int width) {
        mMaxWidth = width;
        return this;
    }
     ...
     * @return The Dialog for chaining methods.
     */
    public MaterialDialog maxHeight(int height) {
        mMaxHeight = height;
        return this;
    }
     ...
     * @return The Dialog for chaining methods.
     */
    public MaterialDialog dimAmount(float amount) {
     ...
     * @return The Dialog for chaining methods.
     */
    public MaterialDialog backgroundColor(int color) {
     ...
     * @return The Dialog for chaining methods.
     */
    public MaterialDialog elevation(float elevation) {
     ...
     * @return The Dialog for chaining methods.
     */
    public MaterialDialog maxElevation(float elevation) {
        mCardView.setMaxCardElevation(elevation);
        return this;
    }
     ...
     * @return The Dialog for chaining methods.
     */
    public MaterialDialog cornerRadius(float radius) {
     ...
     * @return The Dialog for chaining methods.
     */
    public MaterialDialog dividerColor(int color) {
     ...
     * @return The Dialog for chaining methods.
     */
    public MaterialDialog dividerHeight(int height) {
     ...
     * @return The Dialog for chaining methods.
     */
    public MaterialDialog title(int id) {
     ...
     * @return The Dialog for chaining methods.
     */
    public MaterialDialog titleColor(int color) {
     ...
     * @return The Dialog for chaining methods.
     */
    public MaterialDialog titleTextAppearance(int resId) {
     ...
     * @return The Dialog for chaining methods.
     */
    public MaterialDialog actionBackground(int id) {
     ...
     * @return The Dialog for chaining methods.
     */
    public MaterialDialog actionBackground(Drawable drawable) {
     ...
     * @return The Dialog for chaining methods.
     */
    public MaterialDialog actionRipple(int resId) {
     ...
     * @return The Dialog for chaining methods.
     */
    public MaterialDialog actionTextAppearance(int resId) {
     ...
     * @return The Dialog for chaining methods.
     */
    public MaterialDialog actionTextColor(ColorStateList color) {
     ...
     * @return The Dialog for chaining methods.
     */
    public MaterialDialog actionTextColor(int color) {
        positiveActionTextColor(color);
        negativeActionTextColor(color);
        neutralActionTextColor(color);
        return this;
     ...
     * @return The Dialog for chaining methods.
     */
    public MaterialDialog positiveAction(CharSequence action) {
//        Typeface typefaceSpan = Typeface.createFromAsset(AppContext.getInstance().getContext().getAssets(), DottegiConst.FONT_MEDIUM);
//        mPositiveAction.setTypeface(typefaceSpan);
     ...
     * @return The Dialog for chaining methods.
     */
    public MaterialDialog positiveAction(int id) {
     ...
     * @return The Dialog for chaining methods.
     */
    public MaterialDialog positiveActionBackground(Drawable drawable) {
     ...
     * @return The Dialog for chaining methods.
     */
    public MaterialDialog positiveActionBackground(int id) {
     ...
     * @return The Dialog for chaining methods.
     */
    public MaterialDialog positiveActionRipple(int resId) {
     ...
     * @return The Dialog for chaining methods.
     */
    public MaterialDialog positiveActionTextAppearance(int resId) {
     ...
     * @return The Dialog for chaining methods.
     */
    public MaterialDialog positiveActionTextColor(ColorStateList color) {
     ...
     * @return The Dialog for chaining methods.
     */
    public MaterialDialog positiveActionTextColor(int color) {
        mPositiveAction.setTextColor(color);
        return this;
    }
     ...
     * @return The Dialog for chaining methods.
     */
    public MaterialDialog positiveActionClickListener(View.OnClickListener listener) {
     ...
     * @return The Dialog for chaining methods.
     */
    public MaterialDialog negativeAction(CharSequence action) {
//        Typeface typefaceSpan = Typeface.createFromAsset(AppContext.getInstance().getContext().getAssets(), DottegiConst.FONT_MEDIUM);
//        mNegativeAction.setTypeface(typefaceSpan);
     ...
     * @return The Dialog for chaining methods.
     */
    public MaterialDialog negativeAction(int id) {
     ...
     * @return The Dialog for chaining methods.
     */
    public MaterialDialog negativeActionBackground(Drawable drawable) {
     ...
     * @return The Dialog for chaining methods.
     */
    public MaterialDialog negativeActionBackground(int id) {
     ...
     * @return The Dialog for chaining methods.
     */
    public MaterialDialog negativeActionRipple(int resId) {
        RippleDrawable drawable = new RippleDrawable.Builder(getContext(), resId).build();
     ...
     * @return The Dialog for chaining methods.
     */
    public MaterialDialog negativeActionTextAppearance(int resId) {
     ...
     * @return The Dialog for chaining methods.
     */
    public MaterialDialog negativeActionTextColor(ColorStateList color) {
     ...
     * @return The Dialog for chaining methods.
     */
    public MaterialDialog negativeActionTextColor(int color) {
        mNegativeAction.setTextColor(color);
        return this;
    }
     ...
     * @return The Dialog for chaining methods.
     */
    public MaterialDialog negativeActionClickListener(View.OnClickListener listener) {
     ...
     * @return The Dialog for chaining methods.
     */
    public MaterialDialog neutralAction(CharSequence action) {
     ...
     * @return The Dialog for chaining methods.
     */
    public MaterialDialog neutralAction(int id) {
     ...
     * @return The Dialog for chaining methods.
     */
    public MaterialDialog neutralActionBackground(Drawable drawable) {
     ...
     * @return The Dialog for chaining methods.
     */
    public MaterialDialog neutralActionBackground(int id) {
     ...
     * @return The Dialog for chaining methods.
     */
    public MaterialDialog neutralActionRipple(int resId) {
        RippleDrawable drawable = new RippleDrawable.Builder(getContext(), resId).build();
     ...
     * @return The Dialog for chaining methods.
     */
    public MaterialDialog neutralActionTextAppearance(int resId) {
     ...
     * @return The Dialog for chaining methods.
     */
    public MaterialDialog neutralActionTextColor(ColorStateList color) {
     ...
     * @return The Dialog for chaining methods.
     */
    public MaterialDialog neutralActionTextColor(int color) {
        mNeutralAction.setTextColor(color);
        return this;
    }
     ...
     * @return The Dialog for chaining methods.
     */
    public MaterialDialog neutralActionClickListener(View.OnClickListener listener) {
     ...
     * @return The Dialog for chaining methods.
     */
    public MaterialDialog layoutDirection(int direction) {
     ...
     * @return The Dialog for chaining methods.
     */
    public MaterialDialog inAnimation(int resId) {
     ...
     * @return The Dialog for chaining methods.
     */
    public MaterialDialog outAnimation(int resId) {
     ...
     * @return The Dialog for chaining methods.
     */
    public MaterialDialog showDivider(boolean show) {
     ...
     * @return The Dialog for chaining methods.
     */
    public MaterialDialog contentView(View v) {
        if (mContent != v) {
            if (mContent != null)
     ...
     * @return The Dialog for chaining methods.
     */
    public MaterialDialog contentView(int layoutId) {
        if (layoutId == 0)
            return this;
     ...
     * @return The Dialog for chaining methods.
     */
    public MaterialDialog canceledOnTouchOutside(boolean cancel) {
     ...
     * @return The Dialog for chaining methods.
     */
    public MaterialDialog contentMargin(int margin) {
     ...
     * @return The Dialog for chaining methods.
     */
    public MaterialDialog contentMargin(int left, int top, int right, int bottom) {
    ...
    public static class Builder implements MaterialDialogFragment.Builder, Parcelable {
        ...
        public Builder() {
            this(com.rey.material.R.style.Material_App_Dialog_Light);
        }
         ...
         * If you want to apply styling to dialog, or get content view, you should do it in {@link #onBuildDone(MaterialDialog)}
         *
         * @param context A Context instance.
         * @param styleId The resourceId of Dialog's style.
         * @return A Dialog instance will be used for styling later.
         */
        protected MaterialDialog onBuild(Context context, int styleId) {
            return new MaterialDialog(context, styleId);
        }
         ...
         */
        protected void onBuildDone(MaterialDialog dialog) {
        }
